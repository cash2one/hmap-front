...
(function () {
  ...
  EditCodingValueController.$inject = ['CodingValueService', '$state', '$uibModalInstance', 'entity','toastr'];

  function EditCodingValueController(CodingValueService, $state, $uibModalInstance, entity,toastr) {
    var vm = this;
    vm.codeValue = entity;
    vm.clear = clear;
    vm.update = update;
