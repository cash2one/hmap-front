...
(function () {
  ...
  AddCodingValueController.$inject = ['CodingValueService', '$state', '$uibModalInstance', 'entity'];

  function AddCodingValueController(CodingValueService, $state, $uibModalInstance, entity) {
    var vm = this;
    vm.codeValue = entity;
    vm.clear = clear;
    vm.add = add;
