...
(function () {
  ...
  EditCodingController.$inject = ['CodingService', '$scope', '$state', '$uibModalInstance', 'entity'];

  function EditCodingController(CodingService, $scope, $state, $uibModalInstance, entity) {
    var vm = this;
    vm.code = entity;
    vm.clear = clear;
