...
(function () {
  ...
  angular.module('hmapFront')
    .controller('AppAuthDetailNewController', AppAuthDetailNewController);

  AppAuthDetailNewController.$inject = ['AppAuthService', '$scope', '$state', '$localStorage', '$sessionStorage', '$timeout', 'Upload', 'BaseConfig','toastr','entity'];

  function AppAuthDetailNewController(AppAuthService, $scope, $state, $localStorage, $sessionStorage, $timeout, Upload, BaseConfig,toastr,entity) {
    var vm = this;
